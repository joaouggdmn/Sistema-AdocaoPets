...
<head>
  ...
  <style>
    ...
    /* Efeito de patinhas animadas decorativas */
    .paw-decoration {
      position: fixed;
      font-size: 30px;
      opacity: 0;
      pointer-events: none;
      animation: pawFall 4s linear infinite;
      z-index: 0;
    }
...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid px-4">
    <a class="navbar-brand fw-bold"><span class="brand-icon">🐾</span>PetShop</a>
  </div>
</nav>
  ...
  <div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-6">
      <div class="card-pet">
        ...
        <form method="POST" action="salvar.php" class="row g-3 mt-2">
          <div class="col-md-12">
